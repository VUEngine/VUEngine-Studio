        ...
        <div>
          {this.vesState.connectedFlashCarts.map((connectedFlashCart: ConnectedFlashCart, index: number) =>
            <div className="flashCart">
              ...
              <div className="flashCartInfo">
                <div>
                  <i className="fa fa-fw fa-microchip"></i> {connectedFlashCart.config.size} MBit
              ({connectedFlashCart.config.padRom ? "Auto Padding" : "No Auto Padding"})
            </div>
                <div>
                  <i className="fa fa-fw fa-usb"></i> {connectedFlashCart.config.vid}:{connectedFlashCart.config.pid}<br />
                  {connectedFlashCart.config.manufacturer}<br />
                  {connectedFlashCart.config.product}
                </div>
                <div>
                  <i className="fa fa-fw fa-terminal"></i> {basename(connectedFlashCart.config.path)} {connectedFlashCart.config.args}
                </div>
              </div>
              {
                ...
                <div className="cartImgWrapper">
                  <img
                    ...
                    style={connectedFlashCart.config.name === VesFlashCartsPreference.property.default[1].name ? {
