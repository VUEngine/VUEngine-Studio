export namespace VesUrls {
    export const SUPPORTERS = "https://github.com/VUEngine/VUEngine-Studio/blob/master/SUPPORTERS";
    export const LICENSE = "https://github.com/VUEngine/VUEngine-Studio/blob/master/LICENSE";
    ...
    export const MAIL_JORGE = "jorgech3@gmail.com";
}