...
type ViewModeMap = Record<string, ViewModeEntries>;

interface ViewModeEntries {
    force: ViewModeEntry[]
    allow: ViewModeEntry[]
}
...
export const VIEW_MODE_WIDGET_MAP: ViewModeMap = {
    [ViewMode.actors]: {
        force: [
            {
    ...
    [ViewMode.sourceCode]: {
        force: [
            {
                widgetId: EXPLORER_VIEW_CONTAINER_ID,
                widgetOptions: {
                    area: 'left',
                    rank: 1,
                },
            ...
            {
                widgetId: SEARCH_VIEW_CONTAINER_ID,
                widgetOptions: {
                    area: 'left',
                    rank: 2,
                }
            ...
            {
                widgetId: SCM_VIEW_CONTAINER_ID,
                widgetOptions: {
                    area: 'left',
                    rank: 3,
                }
            ...
            {
                widgetId: 'ves-plugins-search-bar',
                widgetOptions: {
                    area: 'left',
                    rank: 4,
                }
