...
export default function RomInfo(props: RomInfoProps): React.JSX.Element {
    ...
    return <VContainer gap={15}>
        <VContainer>
            ...
            <Input
                ...
                style={{ width: 288 }}
                setValue={t => setGameTitle(t as string)}
            />
        </VContainer>
        <VContainer>
            <InfoLabel
            ...
            <HContainer gap={15}>
                ...
                <VContainer>
                    ...
                    <Input
                        ...
                        width={80}
                        setValue={t => setGameCodeId(t as string)}
                    />
                </VContainer>
                <VContainer>
                    <InfoLabel
                    ...
                    <Input
                        ...
                        width={80}
                        setValue={t => setGameCodeLanguage(t as string)}
                    />
                </VContainer>
            </HContainer>
        </VContainer>
        <VContainer>
            ...
            <Input
                ...
                width={80}
                setValue={t => setMakerCode(t as string)}
            />
        </VContainer>
        <VContainer>
            <InfoLabel
            ...
            <HContainer alignItems="center">
                ...
                <Input
                    type="number"
                    value={data.revision}
                    setValue={t => setRevision(t as number)}
