...
For a nice progression, each shade should be about twice as big as the previous one.'
                ...
                <HContainer>
                    <Input
                        ...
                        setValue={v => setBrightnessBright(v as number)}
                    ...
                    <Input
                        ...
                        setValue={v => setBrightnessMedium(v as number)}
                    ...
                    <Input
                        ...
                        setValue={v => setBrightnessDark(v as number)}
            ...
            <VContainer>
                <Input
                    ...
                    setValue={v => setFadeDelay(v as number)}
            ...
            <VContainer>
                <Input
                    ...
                    setValue={v => setFadeIncrement(v as number)}
