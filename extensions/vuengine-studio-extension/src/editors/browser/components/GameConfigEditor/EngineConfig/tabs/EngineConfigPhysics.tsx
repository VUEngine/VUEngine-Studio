...
Smaller values allow movement to start when colliding against a collider and trying to move towards it.'
                ...
                setValue={v => setAngleToPreventColliderDisplacement(v as number)}
            ...
            <Input
                ...
                setValue={v => setFrictionForceFactorPower(v as number)}
            ...
            <Input
                ...
                setValue={v => setGravity(v as number)}
            ...
            <Input
                ...
                setValue={v => setMaximumBouncinessCoefficient(v as number)}
            ...
            <Input
                ...
                setValue={v => setMaximumFrictionCoefficient(v as number)}
            ...
            <Input
                ...
                setValue={v => setStopBouncingVelocityThreshold(v as number)}
            ...
            <Input
                ...
                setValue={v => setStopVelocityThreshold(v as number)}
            ...
            <Input
                ...
                setValue={v => setTimeElapsedDivisor(v as number)}
            ...
            <Input
                ...
                setValue={v => setCollidersMaximumSize(v as number)}
