    ...
    return (
        <VContainer gap={15}>
            <Input
                ...
                setValue={v => setBaseFactor(v as number)}
            ...
            <Input
                ...
                setValue={v => setCameraNearPlane(v as number)}
            ...
            <VContainer>
                ...
                <HContainer>
                    <Input
                        ...
                        setValue={v => setMaximumXViewDistance(v as number)}
                    ...
                    <Input
                        ...
                        setValue={v => setMaximumYViewDistance(v as number)}
            ...
            <Input
                ...
                setValue={v => setScalingModifierFactor(v as number)}
            ...
            <VContainer>
                ...
                <HContainer>
                    <Input
                        ...
                        setValue={v => setScreenWidth(v as number)}
                    ...
                    <Input
                        ...
                        setValue={v => setScreenHeight(v as number)}
                    ...
                    <Input
                        ...
                        setValue={v => setScreenDepth(v as number)}
            ...
            <VContainer>
                ...
                <HContainer>
                    <Input
                        ...
                        setValue={v => setHorizontalViewPointCenter(v as number)}
                    ...
                    <Input
                        ...
                        setValue={v => setVerticalViewPointCenter(v as number)}
