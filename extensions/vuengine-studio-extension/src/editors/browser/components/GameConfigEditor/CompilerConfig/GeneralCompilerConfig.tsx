...
import { CompilerConfigData, CompilerOptimization } from './CompilerConfigTypes';

interface GeneralCompilerConfigProps {
    data: CompilerConfigData
    updateData: (data: CompilerConfigData) => void
}

export default function GeneralCompilerConfig(props: GeneralCompilerConfigProps): React.JSX.Element {
