...
export const VSU_VOLUME_MIN = 0;
export const VSU_VOLUME_MAX = 15;
export const VSU_VOLUME_DEFAULT = 11;
export const VSU_ENVELOPE_INITIAL_VALUE_MIN = VSU_VOLUME_MIN;
export const VSU_ENVELOPE_INITIAL_VALUE_MAX = VSU_VOLUME_MAX;
export const VSU_ENVELOPE_INITIAL_VALUE_DEFAULT = VSU_VOLUME_DEFAULT;
