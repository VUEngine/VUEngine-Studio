...
export interface CanvasDataChangeParams {
...
export interface CanvasGridChangeParams {
  dimensions: {
    columnCount: number;
    rowCount: number;
  };
...
export interface CanvasStrokeEndParams {
...
export interface CanvasBrushChangeParams {
  brushColor: string;
  brushTool: BrushTool;
...
export interface CanvasHoverPixelChangeParams {
  indices: {
    rowIndex: number;
    columnIndex: number;
  } | null;
...
export interface LayerChangeParams {
...
export interface CanvasInfoChangeParams {
  panZoom: PanZoom;
...
export interface SelectAreaRange {
  startWorldPos: Coord;
  endWorldPos: Coord;
...
export interface LayerDataForHook {
  id: string;
  isVisible: boolean;
  data: Array<Array<PixelModifyItem>>;
}

export interface AddGridIndicesParams {
...
export interface DeleteGridIndicesParams {
  rowIndices: Array<number>;
  columnIndices: Array<number>;
  layerId?: string;
  isLocalChange?: boolean;
