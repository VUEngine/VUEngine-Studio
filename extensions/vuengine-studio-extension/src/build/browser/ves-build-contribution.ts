  ...
  async buildModeQuickPick(buildMode?: BuildMode): Promise<void> {
    ...
    const buildTypes = [
      ...
      },
      {
        ...
        iconClasses: (BuildMode.Preprocessor === currentBuildMode) ? ['fa', 'fa-check-square'] : ['fa', 'fa-square-o'],
      }
    ];
