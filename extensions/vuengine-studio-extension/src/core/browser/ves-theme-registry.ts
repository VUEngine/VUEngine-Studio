...
export class VesThemeRegistry extends MonacoThemeRegistry {
    initializeDefaultThemes(): void {
        this.register(require('../../../themes/vuengine-dark-color-theme.json'), {
        ...
        this.register(require('../../../themes/vuengine-light-color-theme.json'), {
            './light_theia.json': require('../../../../../node_modules/@theia/monaco/data/monaco-themes/vscode/light_theia.json'),
